...
namespace TestProject1
{
    public class ProfileTest
    {
        ...
        {
            _calc = new Calc();
            _profileService = new ProfileService(null, new ProfileSum(), null, _calc); // 初始化 ProfileService
        }
        ...
        public async Task TestCalculation()
        {
            ...
            // Act
            var TMHIOList = await _profileService.GetProfileList(TMHIOs.Cast<dynamic>().ToList());
            var HCMIOList = await _profileService.GetProfileList(HCMIOs.Cast<dynamic>().ToList());
            var profileList = TMHIOList.Concat(HCMIOList).ToList();
            var billSum = await _profileService.GetBillSum(profileList);
            var profile = await _profileService.GetProfileSum(billSum, profileList);

            // Assert
            Assert.NotNull(billSum);
            Assert.AreEqual("0000", profile.errcode, "errcode錯誤");
            Assert.AreEqual("成功", profile.errmsg, "errmsg錯誤");
            Assert.AreEqual(-12855m, profile.netamt, "netamt");
            Assert.AreEqual(46090m, profile.fee, "fee");
            ...
            Assert.AreEqual(46090m, billSum.cnfee, "cnfee");
            Assert.AreEqual(100m, billSum.cntax, "cntax");
            Assert.AreEqual(-12855m, billSum.cnnetamt, "cnnetamt");
        ...
        public async Task TestCalculation_TMHIO()
        {
            ...
            // Act
            var profileList = await _profileService.GetProfileList(TMHIOs.Cast<dynamic>().ToList());
            var billSum = await _profileService.GetBillSum(profileList);
            var profile = await _profileService.GetProfileSum(billSum, profileList);
            ...
            Assert.AreEqual("0000", profile.errcode, "errcode錯誤");
            Assert.AreEqual("成功", profile.errmsg, "errmsg錯誤");
            Assert.AreEqual(33260m, profile.netamt, "netamt");
            Assert.AreEqual(40m, profile.fee, "fee");
            Assert.AreEqual(100m, profile.tax, "tax");
            ...
            Assert.AreEqual(15500m, billSum.cnsamt, "cnsamt");
            Assert.AreEqual(40m, billSum.cnfee, "cnfee");
            Assert.AreEqual(100m, billSum.cntax, "cntax");
            Assert.AreEqual(33260m, billSum.cnnetamt, "cnnetamt");
        ...
        public async Task TestCalculation_HCMIO()
        {
            ...
            // Act
            var profileList = await _profileService.GetProfileList(HCMIOs.Cast<dynamic>().ToList());
            var billSum = await _profileService.GetBillSum(profileList);
            var profile = await _profileService.GetProfileSum(billSum, profileList);
            ...
            Assert.AreEqual(46050m, profile.fee, "fee");
            ...
            Assert.AreEqual(46050m, billSum.cnfee, "cnfee");
